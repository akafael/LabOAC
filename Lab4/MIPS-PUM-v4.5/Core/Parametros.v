...
/* Campo FUNCT */
    ...
    FUNSLTU     = 6'h2B,
	 ...
	 FUNMADD		 = 6'h00,					 // 2/2016	AluOp <= 11 para diferenciar FUN iguais para ULA
...
/* Campo OPCODE */
    ...
    OPCFLT      = 6'h11,                /*OPCODE para operacoes da FPU*/
	 ...
	 OPMACC		 = 6'h1C,					 // 2/2016 - Operacao multiply accumulate 
...
/* ADDRESS MACROS *****************************************************************************************************/
    ...
    RS232_CONTROL_ADDRESS       = 32'hFFFF0122,
	 ...
	 IrDA_READ_ADDRESS          = 32'hFFFF0264,
    IrDA_WRITE_ADDRESS         = 32'hFFFF0268,
    IrDA_CONTROL_ADDRESS       = 32'hFFFF0260,
